...
export function Modal({
  ...
  return (
    <div
      className="fixed inset-0 z-40 flex items-end md:items-center justify-center p-0 md:p-8"
      style={{ background: "rgba(13, 12, 11, 0.82)" }}
      onClick={onClose}
    >
      <div
        className="panel-card rise-in w-full md:max-w-2xl max-h-[88vh] overflow-y-auto rounded-b-none md:rounded-b-md"
