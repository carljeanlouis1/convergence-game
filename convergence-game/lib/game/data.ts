...
> = {
  ...
  "foundation-private-model-lab": { tier: 1, requiredRoleKeywords: ["Platform"] },
  ...
  "foundation-sovereign-lease": { tier: 2, prerequisitePrograms: ["foundation-enterprise-api", "foundation-private-model-lab"], requiredRoleKeywords: ["Policy"] },
  ...
  "alignment-policy-rapid-response": { tier: 1, requiredRoleKeywords: ["Policy"] },
  ...
  "alignment-assurance-cloud": { tier: 2, prerequisitePrograms: ["alignment-assurance-audits", "alignment-policy-rapid-response"], requiredRoleKeywords: ["Product"] },
  ...
  "simulation-sovereign-engine": { tier: 2, prerequisitePrograms: ["simulation-executive-briefings", "simulation-climate-command"], requiredRoleKeywords: ["Policy"] },
  ...
  "robotics-autonomy-integrator": { tier: 1, requiredRoleKeywords: ["Autonomy"] },
  ...
  "robotics-humanoid-contracts": { tier: 2, prerequisitePrograms: ["robotics-warehouse-fleet", "robotics-autonomy-integrator"], requiredRoleKeywords: ["Autonomy"] },
  ...
  "biology-biomarker-desk": { tier: 1, requiredRoleKeywords: ["Biosecurity"] },
  ...
  "biology-biosecurity-grid": { tier: 2, prerequisitePrograms: ["biology-hospital-data-commons", "biology-biomarker-desk"], requiredRoleKeywords: ["Biosecurity"] },
  ...
  "materials-thermal-systems-desk": { tier: 1, requiredRoleKeywords: ["Energy"] },
  ...
  "materials-adaptive-platform": { tier: 2, prerequisitePrograms: ["materials-licensing-desk", "materials-prototyping-studio"] },
  ...
  "quantum-post-quantum-desk": { tier: 1, requiredRoleKeywords: ["Security"] },
  "quantum-advantage-access": { tier: 2, prerequisitePrograms: ["quantum-hardware-access"], requiredRoleKeywords: ["Quantum"] },
  "quantum-transition-authority": { tier: 2, prerequisitePrograms: ["quantum-security-retainers", "quantum-post-quantum-desk"], requiredRoleKeywords: ["Security"] },
  ...
  "space-launch-brokerage": { tier: 1, requiredRoleKeywords: ["Orbital"] },
  "space-construction-mission-ops": { tier: 2, prerequisitePrograms: ["space-launch-brokerage", "space-orbital-services"], requiredRoleKeywords: ["Orbital"] },
  "space-launch-mesh": { tier: 2, prerequisitePrograms: ["space-ground-network", "space-launch-brokerage"], requiredRoleKeywords: ["Satellite"] },
